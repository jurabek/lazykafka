...
- When you want to test TUI app, always run it inside tmux session, and use the `tmux` command to attach to the session
- For testing run docker-compose up -d it has kafka broker to interact and test 
